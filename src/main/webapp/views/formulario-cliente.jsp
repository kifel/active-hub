...
<body>
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/clientes${cliente.id != null ? '/' + cliente.id : ''}" method="POST">
            ...
            <div class="form-group">
                ...
                <a href="${pageContext.request.contextPath}/views/clientes.jsp" class="btn btn-secondary">Cancelar</a>
            </div>
        </form>
    </div>
</body>
